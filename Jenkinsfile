...
stage('Deploy') {
    node {
       ...
       // http://54.70.187.156:8081/repository/demoapp-rele/br/com/meetup/ansible/soccer-stats/0.0.2-3/soccer-stats-0.0.2-3.war                           
        def artifactUrl = "http://${NEXUS_URL}/repository/demoapp-rele/br/com/meetup/ansiblea75e53f8-48ab-4c25-84b2-dfcb7981148b/soccer-stats/0.0.2-${BUILD_NUMBER}/soccer-stats-0.0.2-${BUILD_NUMBER}.war"
